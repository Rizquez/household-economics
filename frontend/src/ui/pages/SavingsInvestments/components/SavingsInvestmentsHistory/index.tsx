...
const SavingsInvestmentsHistory = (props: SavingsInvestmentsHistoryProps) => {
  ...
  return (
    <section className="flex min-h-0 min-w-0 flex-col overflow-hidden rounded-xl border border-text-secondary/10 bg-surface">
      ...
      <div className="grid gap-4 border-b border-text-secondary/10 p-4 lg:grid-cols-2">
        <div className="flex flex-col gap-1">
          <span className="text-sm text-text-secondary">
            Total invested cumulative
          </span>

          <span className="min-w-0 wrap-break-word text-xl font-semibold text-text-primary">
        ...
        <table className="w-full min-w-180 border-collapse bg-surface text-sm">
          ...
          <tfoot>
            <tr className="border-t border-text-secondary/10 bg-background font-semibold">
              ...
              <td className="sticky bottom-0 whitespace-nowrap bg-background px-4 py-3 text-right text-text-primary">
