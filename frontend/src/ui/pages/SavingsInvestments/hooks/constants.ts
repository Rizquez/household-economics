...
export const SAVINGS_INVESTMENT_AVAILABLE_QUERY_KEY =
  "savings-investment-available";

export const SAVINGS_INVESTMENTS_PERIODS_QUERY_KEY =
  "savings-investments-periods";
